...
public class ContactListAdapter extends ArrayAdapter<Contact>
{
    ...
    public ContactListAdapter(Context addDialogFragment, int activity_listview, List contactsList)
    {
        super(addDialogFragment,activity_listview,contactsList);
        listItemLayout = activity_listview;
    }
